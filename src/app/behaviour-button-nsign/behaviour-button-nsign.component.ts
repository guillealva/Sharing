...
export class BehaviourButtonNsignComponent {
  ...
  onClick(): void {
    ...
    this.dataService.setSelectedButton('behaviour-button-nsign');  // Puedes usar 'button1', 'button2', etc. para identificar cada botón
  }

  isSelected(): boolean {
    return this.dataService.getSelectedButton() === 'behaviour-button-nsign'; 
