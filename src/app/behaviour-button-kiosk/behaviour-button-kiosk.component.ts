...
export class BehaviourButtonKioskComponent {
  ...
  onClick(): void {
    ...
    this.dataService.setSelectedButton('behaviour-button-kiosk');  // Puedes usar 'button1', 'button2', etc. para identificar cada botón
  }

  isSelected(): boolean {
    return this.dataService.getSelectedButton() === 'behaviour-button-kiosk'; 
